    ...
    <div className="grid grid-cols-1 gap-1 p-4 md:grid-cols-3">
      ...
      >
        <div className="flex flex-col p-4 tracking-tight text-slate-100/50 w-[20rem] h-[20rem]">
          ...
          <div className="font-normal text-slate-500">
            A MERN stack web app with payment integration and email subscription
            for creating, subscribing to, and managing publications.
          </div>
          <a
            href="https://newsletter-prototype-frontend.vercel.app"
            target="_blank"
      ...
      >
        <div className="flex flex-col p-4 tracking-tight text-slate-100/50 w-[20rem] h-[20rem]">
          ...
          <div className="font-normal text-slate-500">
            A MERN stack web app for tracking personal expenses and viewing them
            in a chart.
          </div>
          <a
            href="https://expense-tracker-psi-five-33.vercel.app"
